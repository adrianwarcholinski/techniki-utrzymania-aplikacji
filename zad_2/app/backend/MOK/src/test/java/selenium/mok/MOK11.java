...
public class MOK11 {
    ...
    @Test
    public void shouldSeeOwnAccountDetails() {
        driver.get(BASE_URL);
        ...
        driver.navigate().refresh(); //do wywalenia
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("edit")));
        assertNotNull(driver.findElement(By.name("name")).getAttribute("value"));
        assertNotNull(driver.findElement(By.name("surname")).getAttribute("value"));
        assertNotNull(driver.findElement(By.name("cardNumber")).getAttribute("value"));
        assertNotNull(driver.findElement(By.name("phoneNumber")).getAttribute("value"));
    }
