...
public class MOK5 {
    ...
    private static final String ALTERED_ACCOUNT_SURNAME = "SeleniumUnblocked";
    ...
    @Test
    void shouldLockAccount() throws InterruptedException {
        driver.get(BASE_URL);
        ...
        assertNull(driver.findElement(By.name("activateCheckbox")).getAttribute("checked"));
    }
}
