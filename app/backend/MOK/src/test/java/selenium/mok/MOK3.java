...
public class MOK3 {
    ...
    private static final String ALTERED_ACCOUNT_SURNAME = "SeleniumNonCustomer";
    ...
    @Test
    void shouldGrantAccessLevel() throws InterruptedException {
        driver.get(BASE_URL);
        ...
        driver.findElement(By.id("phone-number-text-field")).sendKeys(phoneNumber);

        driver.findElement(By.name("grantAccessLevelButton")).click();
